...
function SignUpPartnership(props) {
  ...
  const socialSign = (e, param) => {
    ...
    if (param === "google") {
      ...
      dispatch(
        Actions.signInWithFacebook("advertiser"),
        props.history,
        "Partnership",
        props?.type ?? "",
        businessInfo ?? {}
  ...
  return (
    <div>
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <input
          type="text"
          // name="business_general_partners"
          name="general_partners"
          className="form-control login-input user-icon"
          placeholder="Name of General Partners"
          ref={register}
        />
        <input
          type="text"
...
export default SignUpPartnership;
